...
while True:
    ...
    tabuleiro_inicial = '''
                        === Aprenda a jogar ===
Quando estiver na sua vez, escolha o número correspondente à posição no tabuleiro para fazer sua jogada nela.
Imprima esse numero como no exemplo, digamos que você queira jogar no centro, então você digita 5.
                             |     |     
                          1  |  2  |  3  
                        _____|_____|_____
                             |     |     
    ...
    print('Você deseja escolher o X ou a O ?', end=' ')
